...
namespace GroupBoizDAL.Migrations
{
    ...
    [Migration("20250219152935_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.NewsArticle", b =>
                {
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.RefreshToken", b =>
                {
                    b.Property<short>("RefreshTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<short>("RefreshTokenId"));
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.SystemAccount", b =>
                {
                    b.Property<short>("AccountId")
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.Category", b =>
                {
                    b.HasOne("GroupBoizDAL.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.NewsArticle", b =>
                {
                    b.HasOne("GroupBoizDAL.Entities.Category", "Category")
                        .WithMany("NewsArticles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_NewsArticle_Category");

                    b.HasOne("GroupBoizDAL.Entities.SystemAccount", "CreatedBy")
                        .WithMany("NewsArticles")
            ...
            modelBuilder.Entity("GroupBoizDAL.Entities.RefreshToken", b =>
                {
                    b.HasOne("GroupBoizDAL.Entities.SystemAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NewsTag", b =>
                {
                    b.HasOne("GroupBoizDAL.Entities.NewsArticle", null)
                        .WithMany()
                        .HasForeignKey("NewsArticleId")
                        .IsRequired()
                        .HasConstraintName("FK_NewsTag_NewsArticle");

                    b.HasOne("GroupBoizDAL.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .IsRequired()
